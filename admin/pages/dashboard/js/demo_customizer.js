$(function () {
  ...
  function o() {
    var e = "light",
      o = "default";
    $(".menu-color-selector.selected").hasClass("color-bright") &&
      ((e = "dark"), (o = "bright")),
      $(".menu-color-selector.selected").hasClass("color-dark") &&
        ((e = "dark"), (o = "default")),
      $(".menu-color-selector.selected").hasClass("color-light") &&
        ((e = "light"), (o = "default")),
      $(".menu-color-selector.selected").hasClass("color-transparent") &&
        ((e = $("body").hasClass("color-scheme-dark") ? "dark" : "light"),
        (o = "transparent")),
    ...
    var s = "light";
    $(".top-bar-color-selector.selected").hasClass("color-bright") &&
      (s = "bright"),
      $(".top-bar-color-selector.selected").hasClass("color-dark") &&
        (s = "dark"),
      $(".top-bar-color-selector.selected").hasClass("color-light") &&
        (s = "light"),
    ...
    var l = "light";
    $(".sub-menu-color-selector.selected").hasClass("color-bright") &&
      (l = "bright"),
      $(".sub-menu-color-selector.selected").hasClass("color-dark") &&
        (l = "dark"),
      $(".sub-menu-color-selector.selected").hasClass("color-light") &&
        (l = "light"),
      $(".menu-w").removeClass(function (e, o) {
    ...
    $(".menu-w").removeClass(function (e, o) {
      ...
      $("body")
        .removeClass("menu-position-top")
        .removeClass("menu-position-side")
        .removeClass("menu-side-left")
        .removeClass("menu-side-right"),
      "top" == t
      ...
      "left" == t &&
        ...
        $(".menu-w .os-dropdown-position-left")
          .removeClass("os-dropdown-position-left")
          .addClass("os-dropdown-position-right")),
      "right" == t &&
        ($(".menu-w")
          .addClass("menu-position-side")
          .addClass("menu-side-right"),
        $("body").addClass("menu-position-side").addClass("menu-side-right"),
        $(".menu-w .os-dropdown-position-right")
          .removeClass("os-dropdown-position-right")
          .addClass("os-dropdown-position-left"));
    ...
    $(".menu-w").removeClass(function (e, o) {
      ...
      "mini" == r
        ? ($('.sub-menu-style-selector option[value="inside"]').attr(
            "disabled",
            "disabled"
          ),
          "left" == t &&
            ($(".menu-actions .os-dropdown-trigger").removeClass(function (
              e,
              o
            ) {
            ...
            $(".menu-actions .os-dropdown-trigger").addClass(
        ...
        : ($('.sub-menu-style-selector option[value="inside"]').removeAttr(
            "disabled",
            "disabled"
          ),
          "left" == t &&
    ...
    $(".menu-w").removeClass(function (e, o) {
      ...
      "yes" == $(".top-bar-visibility-selector").val()
        ? $(".top-bar").removeClass("d-none")
        : $(".top-bar").addClass("d-none"),
      "yes" == $(".full-screen-selector").val()
        ? $("body").addClass("full-screen")
        : $("body").removeClass("full-screen"),
      "yes" == $(".with-image-selector").val()
    ...
    "yes" == $(".top-bar-above-menu-selector").val()
      ...
      : $(".all-wrapper > .top-bar").length &&
        ((n = $(".all-wrapper > .top-bar")),
        $(".content-w").prepend(n),
        $(".all-wrapper > .top-bar").remove()),
      "inside" == $(".sub-menu-style-selector").val() &&
      "top" != $(".menu-position-selector").val() &&
      $(".menu-w.menu-activated-on-hover").length
        ? ($(".menu-activated-on-hover").off(
            "mouseenter",
          ...
          $(".menu-w")
            .removeClass("menu-activated-on-hover")
        ...
        : !$(".menu-w.menu-activated-on-click").length ||
          ...
          $(".menu-w")
            .addClass("menu-activated-on-hover")
            .removeClass("menu-activated-on-click"),
          os_init_sub_menus());
  }
